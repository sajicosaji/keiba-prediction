...
EV_MAIN_TH    = 1.8   # ◎: EV>=1.8 & オッズ<=50倍 → 修復後回収率 125% (1日約4.5R)
EV_MAIN_CAP   = 50.0
EV_LONG_TH    = 2.2   # ◎以外: EV>=2.2 & オッズ<=30倍・1レース1点 → 修復後回収率 133% (1日約4R)
EV_LONG_CAP   = 30.0  # 穴はオッズ上限を厳しく（旧EV3.0は修復後データで47%と判明→2.2へ）
